...
include("dbconnect.php"); 
    ...
    $itempick = oci_parse($itemcon, "select * from PRODUCT where CATEGORY='UNIFORM'");
	...
	while ($row = oci_fetch_array($itempick))
	{
		...
		echo '<img src="image/'.$row['PICTURE'].'" style="width:100px;height:100px;">';
